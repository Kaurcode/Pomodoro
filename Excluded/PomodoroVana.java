...
public class PomodoroVana {
    ...
    public PomodoroVana(LocalTime produktiivsusAegSekundites, LocalTime puhkeAegSekundites, boolean kasTehtud) {
    ...
    public PomodoroVana(LocalTime produktiivsusAegSekundites, LocalTime puhkeAegSekundites) {
